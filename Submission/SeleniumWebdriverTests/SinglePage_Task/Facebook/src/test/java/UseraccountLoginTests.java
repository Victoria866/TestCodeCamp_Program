...
public class UseraccountLoginTests {
    ...
    public void loginTest() throws InterruptedException {
        //Click on the username field and input a valid username "viktoriabam@gmail.com"
        driver.findElement(By.id("email")).sendKeys("viktoriabam@gmail.com");
        //locate the email field and use your own valid password "victoria8"
        driver.findElement(By.id("pass")).sendKeys("victoria8");
    ...
    public void logoutTest() throws InterruptedException {
        ...
        if(driver.getCurrentUrl().contains("https://web.facebook.com/?stype=lo&jlou=AfeFGQI3YBuPnV0BIsxG7rVG01qP8n0MHxIec4O4ug-gdTFsNpsiWAXHXETOePuPWbNT1GXd_StlslDeXM5on16GpH0EkL7sgTlRTPVuWVfI7w&smuh=2804&lh=Ac-qsp7ub6hOhxFe4Ok")) {
